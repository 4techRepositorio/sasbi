# ADR-002 — Padrões de documentação técnica
...
6. **ADR numeração** — decisões arquitecturais relevantes recebem ADR sequencial; runtime Desktop (Electron vs Tauri) fica reservado a **ADR-003** após spike TICKET-017.
